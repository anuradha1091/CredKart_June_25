    ...
    def test_CredKart_Title_001(self):
        ...
        if self.driver.title == "CredKart1":
            ...
            self.driver.save_screenshot(
                r"D:\01. CredKart_pytest_framework\Screenshots\User login Successfully.png"
                )
            allure.attach.file(r"D:\01. CredKart_pytest_framework\Screenshots\User login Successfully.png", name="User login Successfully", attachment_type=allure.attachment_type.PNG)
            assert True
        else:
            self.log.info("Landed on incorrect page and it's title is: " + self.driver.title)
            self.log.info("Taking screenshot")
            self.driver.save_screenshot(r"D:\01. CredKart_pytest_framework\Screenshots\User login Failed.png")
            allure.attach.file(r"D:\01. CredKart_pytest_framework\Screenshots\User login Failed.png", name="User login Failed", attachment_type=allure.attachment_type.PNG)
